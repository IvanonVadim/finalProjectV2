      ...
      [
        {
          ...
          price: 100,
          answer:
            'Потому что они слишком "скользкие" и могут вызвать пищевое отравление.',
          createdAt: new Date(),
          updatedAt: new Date(),
        },

        {
          ...
          price: 100,
          answer:
            'Дерево, которое всегда готово к сдаче экзамена, называется "ответственность".',
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
          ...
          price: 100,
          answer:
            'Грибы находятся на вечеринке, но не танцуют, потому что им некуда ставить ноги.',
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
          ...
          price: 100,
          answer:
            'Инструмент, который часто забывают в оркестре, - это дирижёр.',
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
